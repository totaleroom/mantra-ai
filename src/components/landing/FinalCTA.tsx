  ...
  return (
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl rounded-xl border border-primary/20 bg-primary/5 p-8 text-center md:p-12">
          ...
          <div className="mb-8 flex flex-wrap items-center justify-center gap-4">
            {badges.map((b) => (
              <div key={b.text} className="flex items-center gap-2 rounded-lg border border-border bg-card px-4 py-2">
