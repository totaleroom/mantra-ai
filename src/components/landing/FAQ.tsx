    ...
    questions: [
      {
        ...
        a: "Nol. Literally nol. Tim kami yang setup semuanya dari A sampai Z. Anda hanya perlu: (1) kasih akses WhatsApp Business, (2) kirim katalog produk/jasa, (3) jawab beberapa pertanyaan tentang bisnis Anda. Sisanya kami yang kerjakan. Anda tinggal approve hasilnya dan mulai terima orderan.",
      },
      {
        q: "Berapa lama proses setup sampai bisa jalan?",
        a: "Rata-rata 1 sampai 2 minggu dari konsultasi awal hingga go-live. Untuk bisnis dengan katalog sederhana, bisa lebih cepat. Ada yang 5 hari sudah live. Yang paling lama biasanya bukan teknis, tapi menunggu owner approve konten dan flow chat-nya 😄",
      },
      {
