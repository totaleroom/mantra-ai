...
const problems = [
  ...
  {
    icon: GraduationCap,
    old: "Butuh training berulang setiap ada produk atau promo baru",
    ...
    <section id="masalah" className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          {/* Cara MANTRA */}
          <div className="space-y-3">
            <h3 className="mb-4 flex items-center gap-2 text-sm font-bold uppercase tracking-wider text-accent">
