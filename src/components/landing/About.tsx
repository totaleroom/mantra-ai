...
const painPoints = [
  ...
  { icon: UserX, title: "Admin Resign = Chaos", desc: "Admin andalan resign, bisnis langsung berantakan. Semua knowledge ada di kepala dia, bukan di sistem." },
  ...
  { icon: MessageSquareWarning, title: "Slow Response", desc: "Customer complain lama dibalas. Padahal tim sudah kewalahan. Chat numpuk, orderan hilang." },
